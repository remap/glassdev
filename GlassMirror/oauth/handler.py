...
class OAuthCodeExchangeHandler(OAuthBaseRequestHandler):
  ...
  def _perform_post_auth_tasks(self, userid, creds):
    ...
    timeline_item_body = {
  "html":"<article><figure><img src='glass://map?w=240&h=360&marker=0;42.369590,-71.107132&marker=1;42.36254,-71.08726&polyline=;42.36254,-71.08726,42.36297,-71.09364,42.36579,-71.09208,42.3697,-71.102,42.37105,-71.10104,42.37067,-71.1001,42.36561, -71.10406,42.36838,-71.10878,42.36968,-71.10703' height=\"360\" width=\"240\"></figure><section><div class=\"text-auto-size\"><p class='blue'>The Hiking Trail App</p><p>Tap to start navigation!</p></div></section></article>",
  'menuItems': [{'action':'NAVIGATE'},{'action':'TOGGLE_PINNED'},{'action':'DELETE'}],
