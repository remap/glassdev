 ...
 *
        ...
        .setContentTitle("GeoPoem")
        .setContentText( "Locaton updated " + locationInfo.getTimestampAgeInSeconds() + " seconds ago")
        .setSmallIcon(R.drawable.notification)
        .setWhen(System.currentTimeMillis())
        .build();
        
    */    
        Intent contentIntent = new Intent(context, VideoplayerActivity.class);
